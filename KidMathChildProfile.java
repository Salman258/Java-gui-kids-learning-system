...
public class KidMathChildProfile{
	...
	public static void start(Stage primaryStage,String inlevel, String inuser,String inpass, String inemail,String inpicture){
		...
		Label lblLecture = new Label("Lecture Progress:");
		Label lblQuiz = new Label("Quiz Progress:");
		Button btnEditProfile = new Button("Edit Profile");
		Button btnBack = new Button("Back");
		ListView<String> listLectureRecord = new ListView<String>();
		ListView<String> listQuizRecord = new ListView<String>();
		
		listLectureRecord.setPrefSize(600, 150);
		listQuizRecord.setPrefSize(600, 150);
		...
		pane.add(lblLecture, 0, 1);
		pane.add(listLectureRecord, 0, 2);
		pane.add(lblQuiz, 0, 3);
		pane.add(listQuizRecord, 0, 4);
		...
		//when user click back button to go back to parent profile
	...
	private static void newEditPage(Stage primaryStage){
		...
		primaryStage.setTitle("Edit Child Account");
		primaryStage.show();
